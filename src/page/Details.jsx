...
const Details = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}?api_key=62a8ce5916fcd0a63bf87efca961b5bc`
      );
  ...
  const fetchTrailer = async () => {
    ...
    try {
      const response = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/videos?api_key=62a8ce5916fcd0a63bf87efca961b5bc`
      );
              ...
              <div className=" lg:w-full w-[100vw] h-min  lg:h-full  ml-0 sm:ml-4">
                <div className=" ml-5">
                  ...
                  <div className=" mt-3 flex ">
                    <p className=" w-24 bg-green-600 mx-2 px-2 py-1 font-bold text-zinc-900 rounded-md text-lg shadow-md shadow-zinc-900">
                      Vote :{" "}
                  ...
                  <div className=" text-zinc-200 mt-5">
                    ...
                    <p className=" w-[80%] sm:w-[70%] md:w-[45rem] lg:w-[80%] xl:w-[70%] text-md font-medium mt-2">
                      {data.overview}
                    </p>
                  </div>
