  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `https://api.themoviedb.org/3/person/${id}/movie_credits?api_key=62a8ce5916fcd0a63bf87efca961b5bc`
      );
  ...
  return (
    <div className=" w-full flex flex-col items-center justify-cente mt-5 ">
        <div className=" w-[90%] text-start">
          <h1 className=" text-zinc-200 text-2xl font-semibold">Cast in Movie</h1>
        </div>
